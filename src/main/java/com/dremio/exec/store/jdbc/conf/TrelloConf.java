...
@SourceType(value = "TrelloARP", label = "Trello",uiConfig = "trello-layout.json")
public class TrelloConf extends AbstractArpConf<TrelloConf> {
  private static final String ARP_FILENAME = "arp/implementation/trello-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.trello.TrelloDriver";
